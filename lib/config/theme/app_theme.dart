...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFe68d62),
      surfaceTint: Color(0xFFe68d62),
      onPrimary: Color(0x000fffff),
      primaryContainer: Color(0xFFffddb2),
      onPrimaryContainer: Color(0xFFbe653a),
      secondary: Color(0xFF134b64),
      onSecondary: Color(0xFFFFFFFF),
      secondaryContainer: Color(0xFF639bb4),
      onSecondaryContainer: Color(0xFF00233c),
      tertiary: Color(0xFFDF9C49),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFFffec99),
      onTertiaryContainer: Color(0xFFb77421),
      ...
      inversePrimary: Color(0xFFd2794e),
      primaryFixed: Color(0xFFffddb2),
      onPrimaryFixed: Color(0xFFaa5126),
      primaryFixedDim: Color(0xFFffc99e),
      onPrimaryFixedVariant: Color(0xFFd2794e),
      secondaryFixed: Color(0xFF639bb4),
      onSecondaryFixed: Color(0xFF000f28),
      secondaryFixedDim: Color(0xFF4f87a0),
      onSecondaryFixedVariant: Color(0xFF003750),
      tertiaryFixed: Color(0xFFffec99),
      onTertiaryFixed: Color(0xFFa3600d),
      tertiaryFixedDim: Color(0xFFffd885),
      onTertiaryFixedVariant: Color(0xFFcb8835),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFd2794e),
      surfaceTint: Color(0xFFd2794e),
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFFaa5126),
      onPrimaryContainer: Color(0xFFFFFFFF),
      secondary: Color(0xFF003750),
      onSecondary: Color(0xFFFFFFFF),
      secondaryContainer: Color(0xFF000f28),
      onSecondaryContainer: Color(0xFFFFFFFF),
      tertiary: Color(0xFFcb8835),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFFa3600d),
      ...
      inversePrimary: Color(0xFFe68d62),
      primaryFixed: Color(0xFFffddb2),
      onPrimaryFixed: Color(0xFFaa5126),
      primaryFixedDim: Color(0xFFffc99e),
      onPrimaryFixedVariant: Color(0xFFd2794e),
